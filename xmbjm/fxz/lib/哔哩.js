...
var rule = {
    ...
    headers:{
        ...
        "Cookie":"buvid3=84B0395D-C9F2-C490-E92E-A09AB48FE26E71636infoc"
    },
    timeout:5000,
    ...
    lazy:`js:
        if (/^http/.test(input)) {
            ...
            let dan = "http://127.0.0.1:9966/api/danmu" + "/?do=danmuku&vodName=" +'https://api.bilibili.com/x/v1/dm/list.so?oid=' + ids[1];
            let result = {};
            let url = "http://127.0.0.1:9977/dash.mpd?do=bili&type=video&aid=" + ids[0] + "&cid=" + ids[1] + "&qn=127";
            result["parse"] = 0;
            result["playUrl"] = "";
            result["url"] = url;
            result["header"] = {
